...
public class Assets {
	...
	public static BufferedImage  cover, combatBack, forestFore,forestMid, forestBack,  inn, rock, tree, gravy_lightning, dog, victory, dog_oil, dog_demon, egg;
	...
	public static void init() { //Load in everything for our game.
		...
		SpriteSheet overWorldStuff = new SpriteSheet(ImageLoader.loadImage("/textures/OverWorldAssetsSprSht.png"));
		...
		tree = overWorldStuff.crop(94, 32, 32, 64);
		rock = overWorldStuff.crop(94, 96, 32, 32);

		cover = ImageLoader.loadImage("/textures/EBCoverWIP.png");
